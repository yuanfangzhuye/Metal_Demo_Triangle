...
vertexShader(uint vertexID [[vertex_id]], constant LcVertex * vertices [[buffer(LcVertexInputIndexVertices)]], constant vector_uint2 *viewportSizePointer [[buffer(LcVertexInputIndexViewportSize)]]) {
